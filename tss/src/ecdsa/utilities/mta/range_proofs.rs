...
impl BobProof {
    pub fn verify(
        ...
        let z_prim =
            (BigInt::mod_pow(h1, &self.s1, N_tilde) * BigInt::mod_pow(h2, &self.s2, N_tilde) * z_e_inv) % N_tilde;
...
pub(crate) mod tests {
    ...
    fn alice_zkp() {
        ...
        let cipher =
            Paillier::encrypt_with_chosen_randomness(&ek, RawPlaintext::from(a.clone()), &Randomness::from(&r))
                .0
                .clone()
                .into_owned();
