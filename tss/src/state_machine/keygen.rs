...
pub struct Keygen {
    ...
    msgs1: Option<Store<BroadcastMsgs<crate::party_i::KeyGenBroadcastMessage1>>>,
    msgs2: Option<Store<BroadcastMsgs<crate::party_i::KeyGenDecommitMessage1>>>,
...
enum M {
    Round1(crate::party_i::KeyGenBroadcastMessage1),
    Round2(crate::party_i::KeyGenDecommitMessage1),
