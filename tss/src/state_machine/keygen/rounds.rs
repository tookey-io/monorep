...
impl Round0 {
    ...
    where
        O: Push<Msg<crate::party_i::KeyGenBroadcastMessage1>>,
    {
...
impl Round1 {
    ...
    where
        O: Push<Msg<crate::party_i::KeyGenDecommitMessage1>>,
    {
        output.push(Msg {
            sender: self.party_i,
            receiver: None,
...
impl Round2 {
    ...
    {
        let params = crate::party_i::Parameters {
            threshold: self.t,
            share_count: self.n,
        };
...
pub struct Round3 {
    ...
    bc_vec: Vec<crate::party_i::KeyGenBroadcastMessage1>,
...
pub struct Round4 {
    ...
    y_vec: Vec<Point<Secp256k1>>,
    bc_vec: Vec<crate::party_i::KeyGenBroadcastMessage1>,
    shared_keys: crate::party_i::SharedKeys,
